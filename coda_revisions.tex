...
\subsection*{[For Section 4.1.3 Baselines] RW Item 5: Peter et al. not directly comparable}

\textit{Note: this revision belongs in Section 4.1.3 (Baselines), not in Related Work. It is recorded here for now and should be moved when we review the Experiments section.}
