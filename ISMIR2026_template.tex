...
\item A silence-driven jump recovery mechanism for arbitrary score discontinuities, evaluated on a repeat-aware jump test benchmark that we contribute for the MSMD test set.
\end{itemize}
