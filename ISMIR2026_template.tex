...
norm~1.0. Data augmentation includes jump augmentation (Section~\ref{subsec:jump}), spatial shifts, tempo scaling,
impulse-response convolution, gain and noise perturbation, and cold-start
truncation.
